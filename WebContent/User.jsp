...
<html>  
    ...
    %> 
        <div id ="contenedor">  
            ...
            <div id ="derecha">
							<center>
							<table WIDTH=50% border="4"><tr><td><center><h1><% out.println(user.getNickname()); %></h1></center></td></tr><tr><td><form action="SvlAddFriend" id="Follow"><button type="submit" form="Follow"><img src="http://www.totemhouse.net.br/img/newUser.png" style="width:15px;height:15px;"><span>Seguir</span></button></form></td></tr></table>
								<table>
									<tr>
